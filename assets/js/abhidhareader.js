...
abhidhaReader.loadText = function() {
	...
	ajaxParams.successCallback = function(response) {
		...
		abhidhaReader.textCache.abhmain = abhidhaReader.formatText(content.slice(0, tikaPos), "abhmain");
		abhidhaReader.textCache.abhtika = abhidhaReader.formatText(content.slice(tikaPos), "abhtika");
		abhidhaReader.getSuttaList("abhtika");
		abhidhaReader.displayText();
	};
	this.util.ajaxLoad(ajaxParams);
};
abhidhaReader.formatText = function(text, book) {
	let result = "";
...
abhidhaReader.displayText = function() {
	this.updateDisplay();
	this.fillSuttaNumberList();
};
abhidhaReader.addBlockQuote = function(element, content) {
	const bq = document.createElement("blockquote");
	bq.innerHTML = content;
	element.appendChild(bq);
};
abhidhaReader.updateDisplay = function() {
...
abhidhaReader.getTikaNumber = function(mainNum) {
	let result = [];
...
abhidhaReader.getSuttaNumber = function(text) {
	let result = "";
...
abhidhaReader.getSuttaList = function(book) {
...
abhidhaReader.findElementAndGo = function(list, str) {
	let success = false;
...
abhidhaReader.goSutta = function() {
