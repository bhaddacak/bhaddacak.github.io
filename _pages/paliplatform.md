...
Now that [*Pāli Platform: The Official Manual*](/ppman){:target="\_blank"} has been available, the full information about the program should be read from the manual.

At the start of 2026, `Pāli Platform 4` has been released with several enhancements and a direction toward Sanskrit learning. This also makes `Pāli Platform 3` deprecated, and its releases will be removed soon.

Some technical information including the download links, partly overlapping with the manual, can be seen here:

> [Pāli Platform 4](/platform4)
