...
- [Pāli Text Reading: A Handbook](/ptr) <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#file-pdf"></use></svg> <span class="label label-green">v3.1</span>
- [Grammatical Suttas of Kaccāyana](/ksut) <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#file-pdf"></use></svg> <span class="label">v0.9.3</span>
...
## หนังสือภาษาไทย
- [ปัญญาสู่อิสรภาพ](/libwis) <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#file-pdf"></use></svg> <span class="label label-green">v1.0.3</span>
...
- [Pāli Platform](/paliplatform) <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#linux"></use></svg> <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#apple"></use></svg> <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#windows"></use></svg>
    - [Pāli Platform 4](/platform4) <span class="label">v4.2.0</span>
- [Pāli Platform Meditation Timer (PPMT)](/ppmt) <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#android"></use></svg> (and meditation tracks)
- [Calendar of Thai Holy Days (ปฏิทินวันพระไทย)](/thaiholydays)

## Online Pāli Text Readers
- [Tipiṭaka Correction Report](/correport)
- [Chaṭṭha Saṅgāyana Tipiṭaka Restructured](/cstpage)
    - [Table of Contents](/cst)
- [SC Sutta Reader](/suttareader)
- [SC Sutta Lister](/suttalister)
...
- [อิสราศรม ทิศาปาโมกข์](https://bhaddacak.github.io/israsom){:target="\_blank"} เพื่อความเข้าใจพุทธศาสนาอย่างมีเหตุผล
	- [Download pdf version](https://github.com/bhaddacak/israsom/releases){:target="\_blank"} <svg class="icon"><use xlink:href="/assets/fontawesome/custom.svg#github-alt"></use></svg>
